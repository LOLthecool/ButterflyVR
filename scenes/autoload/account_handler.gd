...
func _ready() -> void:
	...
	renew_timer.wait_time = TOKEN_RENEWAL_CHECK_RATE # 30 minutes
...
func on_token_request(response_code:HTTPClient.ResponseCode, headers:PackedStringArray, body:String) -> void:
	pass
